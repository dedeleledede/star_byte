...
- Fastify backend for constellation/admin deployment.
...
- Connects to constellation over HTTPS/WSS.
...
Desktop production builds need constellation URLs:
...
GitHub Actions does not need SSH access to constellation.
